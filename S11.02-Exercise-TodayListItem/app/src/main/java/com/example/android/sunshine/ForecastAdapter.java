...
class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private View createView(ViewGroup viewGroup, int viewType) {
        switch (viewType) {
            case VIEW_TYPE_TODAY:
                return LayoutInflater
                        .from(mContext)
                        .inflate(R.layout.forecast_for_today_list_item, viewGroup, false);
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        int weatherImageId = getWeatherImageId(forecastAdapterViewHolder.viewType, weatherId);
    ...
    private int getWeatherImageId(int viewType, int weatherId) {
        switch (viewType) {
            case VIEW_TYPE_TODAY:
                return SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId);
            case VIEW_TYPE_FUTURE_DAY:
                return SunshineWeatherUtils.getSmallArtResourceIdForWeatherCondition(weatherId);
            default:
                throw new IllegalArgumentException("Unknown view type: " + viewType);
        }
    }
