...
public class WeatherProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        Cursor cursor = executeQuery(uri, projection, selection, selectionArgs, sortOrder);
        cursor.setNotificationUri(getContext().getContentResolver(), uri);
        return cursor;
    }

    private Cursor executeQuery(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (match) {
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                return queryForWeatherEntryByDate(db, date, projection, sortOrder);
            default:
                throw new UnsupportedOperationException("Unknown URI: " + uri);
        }
    }

    private Cursor queryForWeatherEntryByDate(SQLiteDatabase db, String date, String[] projection, String sortOrder) {
